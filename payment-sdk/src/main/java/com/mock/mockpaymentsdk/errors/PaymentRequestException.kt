...
class PaymentRequestException(exception: Exception) : Exception("Invalid payment request")
...
class PaymentRetryRequestException : Exception("Retry payment request failed")